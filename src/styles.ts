export const APP_STYLES = `
  * { box-sizing: border-box; }
  ...
  .card.dark .quote-customer-panel {
    border-top-color: #374151;
  }
  .quote-customer-panel-header {
    display: flex;
    align-items: center;
    justify-content: space-between;
    gap: 12px;
  ...
  .quote-customer-panel-header h4 {
    margin: 0;
    font-size: 1rem;
  }
...
.contractor-trade-helper {
  ...
  .app-shell.dark .quote-row.scope {
    border-bottom-color: #1f2937;
  }
  .scope-line-main,
  .scope-line-secondary {
    display: grid;
    grid-template-columns: minmax(0, 1.8fr) minmax(90px, 0.7fr) minmax(110px, 0.8fr);
    gap: 10px;
    align-items: end;
  }
  .scope-line-secondary {
    grid-template-columns: minmax(120px, 1fr) minmax(150px, 1.1fr) minmax(130px, 1fr) auto;
  }
  .scope-line-main label,
  .scope-line-secondary label {
    display: flex;
    flex-direction: column;
    gap: 6px;
    min-width: 0;
  ...
  .app-shell.dark .scope-line-main label,
  ...
  .scope-photo-picker > span:first-child {
    display: inline-flex;
    align-items: center;
    gap: 6px;
    color: #111827;
  }
  .scope-photo-picker input {
    width: 1px;
    height: 1px;
    opacity: 0;
    position: absolute;
  ...
  .scope-assignment-readonly strong {
    color: #111827;
    font-size: 0.95rem;
  }
  .app-shell.dark .scope-photo-picker {
    border-color: #475569;
    background: #111827;
  }
  .app-shell.dark .scope-photo-picker > span:first-child,
  .app-shell.dark .scope-assignment-readonly strong {
    color: #f9fafb;
  }
  .room-name-row {
    display: grid;
  ...
  .app-shell.dark .schedule-card.selected {
    border-color: #60a5fa;
  ...
  .user-account-create-trigger,
  .user-account-create-panel {
    margin-top: 14px;
  }
  .user-account-list {
    display: flex;
  ...
  .user-account-row-editing {
    align-items: stretch;
    flex-direction: column;
  }
  .user-account-edit-grid {
    display: grid;
    grid-template-columns: repeat(4, minmax(0, 1fr));
    gap: 12px;
  }
  .user-account-edit-grid label {
    display: flex;
    flex-direction: column;
    gap: 6px;
    min-width: 0;
  ...
  .app-shell.dark .user-account-row {
    border-color: #374151;
    background: #0f172a;
  }
  .app-shell.dark .user-account-access-panel {
    border-color: #374151;
    background: #111827;
  }
  .app-shell.dark .password-visibility-toggle {
    border-color: #475569;
    background: #1f2937;
    color: #f8fafc;
  }
  .app-shell.dark .password-visibility-toggle:hover {
    border-color: #64748b;
    background: #334155;
  }
  .access-control-grid {
  ...
  .app-shell.dark .access-role-panel {
    border-color: #374151;
    background: #0f172a;
  }
  .app-shell.dark .access-role-panel h4 {
    color: #f9fafb;
  }
  .server-actions {
    margin-top: 18px;
  ...
  :root {
    ...
    --surface-panel-alt: #f8fafc;
    --surface-sidebar: #111827;
    --surface-sidebar-soft: #1f2937;
    --text-main: #172033;
    --text-muted: #667085;
    --border-soft: #d9e2ec;
    ...
    --warning: #b45309;
    --danger: #b91c1c;
    --shadow-panel: 0 14px 30px rgba(15, 23, 42, 0.08);
  }
  ...
  .app-shell {
    ...
    background:
      linear-gradient(180deg, rgba(255, 255, 255, 0.65), rgba(238, 242, 246, 0) 220px),
      var(--surface-page);
    color: var(--text-main);
  }
  ...
  .app-shell.dark {
    ...
    --surface-panel-alt: #182235;
    --surface-sidebar: #020617;
    --surface-sidebar-soft: #111827;
    --text-main: #eef2ff;
    --text-muted: #aab4c4;
    --border-soft: #273449;
    ...
    --shadow-panel: 0 18px 38px rgba(0, 0, 0, 0.28);
    background:
      linear-gradient(180deg, rgba(30, 41, 59, 0.46), rgba(11, 17, 32, 0) 240px),
      var(--surface-page);
    color: var(--text-main);
  }
  ...
  .app-shell.dark .sidebar-subtitle {
    color: #9ca3af;
  }
  ...
  .sidebar-toggle:hover,
  .app-shell.dark .sidebar-toggle:hover {
  ...
  .sidebar-user-popover button:last-child {
    border-bottom: 0;
  }

  .sidebar-user-popover button:hover {
    background: #f8fafc;
  }

  .app-shell.dark .sidebar-user-popover {
    border-color: #374151;
    background: #111827;
    color: #f9fafb;
  ...
  .app-shell.dark .sidebar-user-popover-header {
    border-bottom-color: #374151;
  }

  .app-shell.dark .sidebar-user-popover-header span {
    color: #9ca3af;
  }

  .app-shell.dark .sidebar-user-popover button {
    border-bottom-color: #1f2937;
    background: #111827;
    color: #f9fafb;
  }

  .app-shell.dark .sidebar-user-popover button:hover {
    background: #1f2937;
  }
  ...
  .app-shell.navigation-closed .nav-list {
    align-items: center;
    width: 100%;
  }

  .app-shell.navigation-closed .nav-item {
    width: 44px;
    height: 44px;
    justify-content: center;
    padding: 0;
  ...
  .app-shell.dark .row-subtitle,
  .app-shell.dark .stat-label {
    color: var(--text-muted);
  }
  ...
  .dashboard-metric-button::before {
    content: "";
    position: absolute;
    inset: 0 auto 0 0;
    width: 4px;
  ...
  .dashboard-metric-button:nth-child(2)::before {
    background: var(--accent);
  }

  .dashboard-metric-button:nth-child(3)::before {
    background: #d97706;
  }

  .dashboard-metric-button:nth-child(4)::before {
    background: #7c3aed;
  }
  ...
  .app-shell.dark .customer-card-work-item,
  .app-shell.dark .customer-job-slider,
  .app-shell.dark .schedule-card,
  .app-shell.dark .template-button-card.dark,
  .app-shell.dark .custom-area-card,
  .app-shell.dark .quote-actions-card {
    border-color: var(--border-soft);
    background: var(--surface-panel-alt);
    color: var(--text-main);
  }
  ...
  .app-shell.dark .analysis-row-button:hover,
  .app-shell.dark .analysis-table-button:hover,
  .app-shell.dark .template-button-card.dark:hover,
  .app-shell.dark .customer-card-work-toggle:hover {
    border-color: var(--brand);
  ...
  @media (max-width: 760px) {
    ...
    .phone-experience .desktop-only-action {
      display: none;
    }
